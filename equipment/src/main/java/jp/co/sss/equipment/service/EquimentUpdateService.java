...
public class EquimentUpdateService {
	 ...
	 * @param serialNo
	 */
	public void equipmentUpdate(EquipmentForm updateform, String serialNo) {
		StockMaster stockMaster = BeanCopy.copyFormToStockMaster(updateform);
		stockMaster.setStockCode(serialNo);
		stockMaster.setDel("0");
		equimentUpdateMapper.equipmentUpdate(stockMaster);
